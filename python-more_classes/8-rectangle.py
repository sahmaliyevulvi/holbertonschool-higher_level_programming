...
It provides width and height validation,
area and perimeter calculation,
printable rectangle using print_symbol,
eval()-friendly repr(),
keeps track of the number of instances,
and provides a static method to compare rectangles.
"""
...
class Rectangle:
    ...
    def __str__(self):
        """Return the rectangle using the print_symbol characters."""
        if self.__width == 0 or self.__height == 0:
            return ""
